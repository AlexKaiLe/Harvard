...
def createModel(train_data_new, train_labels_new, test_data_new, test_labels_new):
    return ml_traning(train_data_new, train_labels_new, test_data_new, test_labels_new)